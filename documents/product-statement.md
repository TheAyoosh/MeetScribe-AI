# MeetScribe AI — Final Product Statement
...
Team leads, project managers, and anyone who regularly sits through browser-based meetings on **Google Meet**, **Zoom**, or **Microsoft Teams**.

---

## Core Value Proposition

| Problem | MeetScribe AI Solution |
|---|---|
| Verbal action items get forgotten (53%+) | Auto-extracts & saves every action item |
| 5–15 min manually updating JIRA/Trello | Auto-generates structured summaries |
| No record of who said what | Real-time transcription + speaker diarization |
| Privacy concerns about AI monitoring | 100% local — no data leaves your device |
...
- 80% of active users save at least **10 minutes per meeting** within 45 days
...
| Name | Role |
|---|---|
| Abhiraj | Team Lead & AI Integration |
| Ayush Kumar | UI/UX & Dashboard |
| Chethana SB | Core Extension Implementation |
| Garvit Singh | Cross-Platform Testing |
| Aditya Raj | Customer Research |
| Hardik Jha | Testing & DevOps |
